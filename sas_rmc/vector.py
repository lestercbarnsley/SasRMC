...
@overload
def cross(a: Sequence[np.ndarray], b: Sequence[np.ndarray]) -> tuple[np.ndarray, ...]: ...

@overload
def cross(a: Sequence[float], b: Sequence[np.ndarray]) -> tuple[np.ndarray, ...]: ...

@overload
def cross(a: Sequence[np.ndarray], b: Sequence[float]) -> tuple[np.ndarray, ...]: ...
...
@overload
def dot(a: Sequence[np.ndarray], b: Sequence[np.ndarray]) -> np.ndarray: ...

@overload
def dot(a: Sequence[float], b: Sequence[np.ndarray]) -> np.ndarray: ...

@overload
def dot(a: Sequence[np.ndarray], b: Sequence[float]) -> np.ndarray: ...
