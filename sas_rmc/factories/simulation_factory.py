...
from sas_rmc.factories.particle_factory import ParticleFactory, create_particle_factory_from_dataframes
...
class SimulationStateFactory:
    ...
    def create_from_dataframes(cls, dataframes: dict[str, pd.DataFrame]):
        ...
        particle_factory = create_particle_factory_from_dataframes(dataframes)
        return cls(
